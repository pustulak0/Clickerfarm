    ...
    adsUpgradePowerButton.addEventListener(
        ...
        async () => {
            ...
            if (
                ...
                console.error(
                    "MONETAG: show_11845666 IS NOT AVAILABLE"
                );
            ...
            try {
                ...
                if (!telegramInitData) {
                    ...
                    console.error(
                        "MONETAG: TELEGRAM INIT DATA MISSING"
                    );
                ...
                /* =========================================
                   CLAIM FARMER REWARD FROM SERVER
                ========================================= */
                ...
                /* =========================================
                   UPDATE FARMER SHOP COST
                ========================================= */

                if (
                    Array.isArray(shopFarmerCosts) &&
                    shopFarmerCosts.length > 0
                ) {
...
/* =========================================================
   TAP POWER WATCH AD BUTTON — MONETAG
========================================================= */

const adsUpgradeTapPowerButton =
    document.getElementById(
        "adsUpgradeTapPowerButton"
    );


if (adsUpgradeTapPowerButton) {

    adsUpgradeTapPowerButton.addEventListener(
        "click",
        async () => {
            ...
            try {
                ...
                console.log(
                    "MONETAG: TAP POWER AD COMPLETED"
                );
                ...
                /* =========================================
                   CLAIM TAP POWER REWARD
                ========================================= */

                console.log(
                    "MONETAG: CLAIMING TAP POWER REWARD"
                );
                ...
                if (
                    ...
                    console.error(
                        "MONETAG TAP POWER REWARD FAILED:",
                        data
                    );
                ...
                console.log(
                    "MONETAG: TAP POWER REWARD APPLIED"
                );
                ...
                console.error(
                    "MONETAG TAP POWER AD / REWARD ERROR:",
                    error
                );
    ...
    console.error(
        "MONETAG: TAP POWER BUTTON NOT FOUND"
    );

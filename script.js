...
function showTadsRewardPopup(message) {
    ...
    /* FORCE POPUP OUT OF ANY POSSIBLE CONTAINER */
    ...
    /* FORCE ALL IMPORTANT DISPLAY VALUES */
    ...
    const box =
        popup.querySelector(".tads-reward-box");

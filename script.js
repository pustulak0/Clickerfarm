...
farmerButtons.forEach(
    function (farmerButton) {

        const farmerNumber =
            Number(
                farmerButton.dataset.farmer
            );
        ...
        const priceElement =
            farmerButton.querySelector("small");
...
shopFarmerCosts =
    Array.isArray(loadedFarmerCosts)
        ? loadedFarmerCosts

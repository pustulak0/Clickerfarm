...
/* =========================
   LOAD HARVEST QUEST COUNTS
========================= */

riceHarvestQuestCount =
    Number(
        data.user?.rice_harvest_quest_count
    ) || 0;

potatoHarvestQuestCount =
    Number(
        data.user?.potato_harvest_quest_count
    ) || 0;

cornHarvestQuestCount =
    Number(
        data.user?.corn_harvest_quest_count
    ) || 0;


console.log(
    "🌾 RICE HARVEST QUEST COUNT:",
    riceHarvestQuestCount
);

console.log(
    "🥔 POTATO HARVEST QUEST COUNT:",
    potatoHarvestQuestCount
);

console.log(
    "🌽 CORN HARVEST QUEST COUNT:",
    cornHarvestQuestCount
);

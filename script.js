...
if (mainQuestBtn) {
    ...
    mainQuestBtn.addEventListener("click", function () {
        ...
        mainQuests.classList.remove("hidden");

        dailyQuests.classList.add("hidden");
...
if (dailyQuestBtn) {
    ...
    dailyQuestBtn.addEventListener("click", function () {
        ...
        dailyQuests.classList.remove("hidden");

        mainQuests.classList.add("hidden");
...
if (joinTelegramQuest) {
    ...
    joinTelegramQuest.addEventListener("click", function () {

        if (telegramQuestCompleted) return;
        ...
        /*
           Give the bonus after clicking JOIN
        */

        telegramQuestCompleted = true;

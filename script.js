...
function checkGemAchievements() {
    ...
    if (totalGemsEarned >= 100 && !gems100AchievementUnlocked) {
    ...
    if (totalGemsEarned >= 250 && !gems250AchievementUnlocked) {
    ...
    if (totalGemsEarned >= 500 && !gems500AchievementUnlocked) {
    ...
    if (totalGemsEarned >= 1000 && !gems1000AchievementUnlocked) {
    ...
    if (totalGemsEarned >= 1750 && !gems1750AchievementUnlocked) {
    ...
    if (totalGemsEarned >= 3000 && !gems3000AchievementUnlocked) {
    ...
    if (totalGemsEarned >= 5000 && !gems5000AchievementUnlocked) {
    ...
    if (totalGemsEarned >= 7500 && !gems7500AchievementUnlocked) {
    ...
    if (totalGemsEarned >= 11000 && !gems11000AchievementUnlocked) {
...
function checkClickAchievements() {
    ...
    if (totalClicks >= 1000 && !clicks1000AchievementUnlocked) {
...
localStorage.setItem("tapBonus", tapBonus);
    ...
    if (totalClicks >= 5000 && !clicks5000AchievementUnlocked) {
...
localStorage.setItem("tapBonus", tapBonus);
    ...
    if (totalClicks >= 12500 && !clicks12500AchievementUnlocked) {
...
localStorage.setItem("tapBonus", tapBonus);
    ...
    if (totalClicks >= 25000 && !clicks25000AchievementUnlocked) {
...
localStorage.setItem("tapBonus", tapBonus);
    ...
    if (totalClicks >= 50000 && !clicks50000AchievementUnlocked) {
...
localStorage.setItem("tapBonus", tapBonus);
    ...
    if (totalClicks >= 80000 && !clicks80000AchievementUnlocked) {
...
localStorage.setItem("tapBonus", tapBonus);
    ...
    if (totalClicks >= 125000 && !clicks125000AchievementUnlocked) {
...
localStorage.setItem("tapBonus", tapBonus);
    ...
    if (totalClicks >= 180000 && !clicks180000AchievementUnlocked) {
...
localStorage.setItem("tapBonus", tapBonus);
    ...
    if (totalClicks >= 250000 && !clicks250000AchievementUnlocked) {
...
let energyFlatBonus =
    Number(localStorage.getItem("energyFlatBonus")) || 0;
...
let maxEnergy =
    Number(localStorage.getItem("maxEnergy"));
...
if (powerDisplay) {
    powerDisplay.textContent = formatNumber(totalTapPower);
}
...
perSecondDisplay.textContent =
   ...
   energyFill.style.width =
    ...
    farmerCostDisplay.textContent =
     ...
     document.getElementById("totalGemsBonus").textContent =
    totalGemsBonus + "%";
...
/* =========================
   TESTNET TON TRANSACTION
========================= */

const testTonPayment =
    document.getElementById("testTonPayment");


if (testTonPayment) {

    testTonPayment.addEventListener(
        "click",
        async function () {

            console.log(
                "TESTNET TON PAYMENT BUTTON CLICKED"
            );
            ...
            if (
                ...
                alert(
                    "❌ Please connect a TESTNET wallet."
                );
    ...
    console.log(
        "Preparing 0.01 TEST TON transaction..."
    );
    ...
    console.log(
        "✅ TESTNET TRANSACTION APPROVED!"
    );


    alert(
        "✅ 0.01 TEST TON transaction sent!\n\nChecking blockchain..."
    );
    ...
    console.log(
        "Checking payment on blockchain..."
    );
    ...
    if (
        ...
        alert(
            "⚠️ Transaction was sent, but blockchain verification did not find it yet."
        );

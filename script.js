...
/* =====================================
   RESET FALLING TOKEN QUEST ON SERVER
===================================== */
...
if (telegramInitData) {
    try {
        ...
        const response =
            await fetch(
                "https://server-72ja.onrender.com/api/reset-falling-token-quest",
                {
                    method: "POST",
                    headers: {
                        "Content-Type":
        ...
        console.log(
            "🍂 FALLING TOKEN QUEST RESET RESPONSE:",
            data
        );
        ...
        if (
            ...
            console.error(
                "Falling Token quest server reset failed:",
                data.error
            );
        }
        ...
        console.error(
            "Falling Token quest server reset error:",
            error
        );
    }
}

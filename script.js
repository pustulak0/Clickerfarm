...
const onShowRewardCallback =
    async (result) => {
        ...
        if (!initData) {
            ...
            console.error(
                "TADS: Telegram initData is missing"
            );
        ...
        console.log(
            "TADS: Sending reward request to server"
        );
        ...
        try {
            ...
            /* =================================================
               TEMPORARILY KEEP CLIENT REWARD
            ================================================= */

...
async function collectFallingTokenForQuest() {
    ...
    try {
        ...
        if (
            ...
            console.error(
                "Falling Token quest progress failed:",
                data.error
            );
            return;
        }
...
/* =====================================
   RESET 500 CLICKS QUEST ON SERVER
===================================== */
...
if (telegramInitData) {
    ...
    try {
        ...
        const response =
            await fetch(
                "https://server-72ja.onrender.com/api/reset-click-quest",
                {
                    method: "POST",
                    headers: {
                        "Content-Type":
        ...
        console.log(
            "🖱️ CLICK 500 QUEST RESET RESPONSE:",
            data
        );

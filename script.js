...
if (closeReferral && referralOverlay) {
...
if (referralOverlay) {
    ...
    referralOverlay.addEventListener("click", function (event) {

        if (event.target === referralOverlay) {
...
/* =========================================================
   LOAD TELEGRAM USER + REFERRAL DATA
========================================================= */
...
async function loadReferralData() {
    ...
    try {
        ...
        const bonus =
            data.coinBonus ??
            data.user?.coin_bonus ??
            0;


        if (referralBonusDisplay) {

            referralBonusDisplay.textContent =
                "+" + bonus + "%";
    ...
    inviteFriends.addEventListener(
        ...
        function () {
            ...
            if (
                ...
                console.log(
                    "Referral link is not loaded yet."
                );
...
/* =========================================================
   CONNECT TELEGRAM USER ON START
========================================================= */
...
async function connectTelegramUser() {
    ...
    try {
        ...
        /* Update referral data immediately */

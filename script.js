...
farmerBtn.addEventListener(
    ...
    function () {
        ...
        if (!farmerQuestCompleted) {

            farmerQuestCompleted = true;

            localStorage.setItem(
                "farmerQuestCompleted",
                "true"
            );
...
function updateFarmerQuest() {

    if (!buyFarmerQuest || !farmerQuestProgress) {
        return;
    }
    ...
    buyFarmerQuest.classList.remove(
        "completed"
    );
}

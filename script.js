...
function updateStatsBonus() {
    ...
    console.log("coinBonus:", coin);
    console.log("boostedCoinsBonus:", boosted);
    console.log("coinAchievementBonus:", achievement);
    console.log("soupBonus:", soup);
    console.log("nightBonus:", night);
    console.log("tonBonus:", ton);
...
try {
    ...
    console.log("TAP SERVER RESPONSE:", data);
    ...
    // USE SERVER COIN BALANCE
    money = Number(data.coins);
...
milestonesCompleted =
    Number(data.user?.milestones_completed) || 0;
...
if (
    ...
    /* =====================================================
       ...
       These are used ONLY for the visual cards.
       The actual winning reward comes from the SERVER.
    ===================================================== */
...
window.updateDailyCaseSpins = updateCaseSpins;
    ...
    /* =====================================================
       ...
       These cards are visual only.
       They do NOT determine the reward.
    ===================================================== */
        ...
        async function () {
            ...
            setTimeout(
                function () {
                    ...
                    /* =========================================
   UPDATE GEM ACHIEVEMENTS FROM SERVER
========================================= */

...
/* =====================================
   RESET 10,000 COINS QUEST ON SERVER
===================================== */
...
if (telegramInitData) {
    ...
    try {
        ...
        const response =
            await fetch(
                "https://server-72ja.onrender.com/api/reset-coin-quest",
                {
                    method: "POST",
                    headers: {
                        "Content-Type":
        ...
        console.log(
            "🪙 DAILY COIN QUEST RESET RESPONSE:",
            data
        );
        ...
        if (
            ...
            console.error(
                "Coin quest server reset failed:",
                data.error
            );
...
/* =====================================
   RESET STAY ONLINE QUEST ON SERVER
===================================== */
...
if (telegramInitData) {
    ...
    try {
        ...
        const response =
            await fetch(
                "https://server-72ja.onrender.com/api/reset-online-quest",
                {
                    method: "POST",
        ...
        console.log(
            "⏱️ DAILY ONLINE QUEST RESET RESPONSE:",
            data
        );
        ...
        if (
            ...
            console.error(
                "Online quest server reset failed:",
                data.error
            );
        ...
        console.error(
            "Online quest server reset error:",
            error
        );
...
/* =====================================
   RESET RICE HARVEST QUEST ON SERVER
===================================== */
...
if (telegramInitData) {
    try {
        ...
        const response =
            await fetch(
                "https://server-72ja.onrender.com/api/reset-rice-harvest-quest",
                {
                    method: "POST",
                    headers: {
                        "Content-Type":
        ...
        console.log(
            "🌾 RICE HARVEST QUEST RESET RESPONSE:",
            data
        );
        ...
        if (
            ...
            console.error(
                "Rice harvest quest server reset failed:",
                data.error
            );
        }
        ...
        console.error(
            "Rice harvest quest server reset error:",
            error
        );
    }
}
...
/* =====================================
   RESET POTATO HARVEST QUEST ON SERVER
===================================== */
...
if (telegramInitData) {
    try {
        ...
        const response =
            await fetch(
                "https://server-72ja.onrender.com/api/reset-potato-harvest-quest",
                {
                    method: "POST",
                    headers: {
                        "Content-Type":
        ...
        console.log(
            "🥔 POTATO HARVEST QUEST RESET RESPONSE:",
            data
        );
        ...
        if (
            ...
            console.error(
                "Potato harvest quest server reset failed:",
                data.error
            );
        }
        ...
        console.error(
            "Potato harvest quest server reset error:",
            error
        );
    }
}
...
/* =====================================
   RESET CORN HARVEST QUEST ON SERVER
===================================== */
...
if (telegramInitData) {
    try {
        ...
        const response =
            await fetch(
                "https://server-72ja.onrender.com/api/reset-corn-harvest-quest",
                {
                    method: "POST",
                    headers: {
                        "Content-Type":
        ...
        console.log(
            "🌽 CORN HARVEST QUEST RESET RESPONSE:",
            data
        );
        ...
        if (
            ...
            console.error(
                "Corn harvest quest server reset failed:",
                data.error
            );
        }
        ...
        console.error(
            "Corn harvest quest server reset error:",
            error
        );
    }
}
...
/* =====================================
   RESET MOON POWER QUEST ON SERVER
===================================== */
...
if (telegramInitData) {
    try {
        ...
        const response =
            await fetch(
                "https://server-72ja.onrender.com/api/reset-moon-power-quest",
                {
                    method: "POST",
                    headers: {
                        "Content-Type":
        ...
        console.log(
            "🌙 MOON POWER QUEST RESET RESPONSE:",
            data
        );
        ...
        if (
            ...
            console.error(
                "Moon Power quest server reset failed:",
                data.error
            );
        }
        ...
        console.error(
            "Moon Power quest server reset error:",
            error
        );
    }
}
...
/* =====================================
   RESET NIGHT INCOME QUEST ON SERVER
===================================== */
...
if (telegramInitData) {
    try {
        ...
        const response =
            await fetch(
                "https://server-72ja.onrender.com/api/reset-night-income-quest",
                {
                    method: "POST",
                    headers: {
                        "Content-Type":
        ...
        console.log(
            "🌙 NIGHT INCOME QUEST RESET RESPONSE:",
            data
        );
        ...
        if (
            ...
            console.error(
                "Night Income quest server reset failed:",
                data.error
            );
        }
        ...
        console.error(
            "Night Income quest server reset error:",
            error
        );
    }
}
...
/* =====================================
   RESET POTATO SOUP QUEST ON SERVER
===================================== */
...
if (telegramInitData) {
    try {
        ...
        const response =
            await fetch(
                "https://server-72ja.onrender.com/api/reset-potato-soup-quest",
                {
                    method: "POST",
                    headers: {
                        "Content-Type":
        ...
        console.log(
            "🥔 POTATO SOUP QUEST RESET RESPONSE:",
            data
        );
        ...
        if (
            ...
            console.error(
                "Potato Soup quest server reset failed:",
                data.error
            );
        }
        ...
        console.error(
            "Potato Soup quest server reset error:",
            error
        );
    }
}
...
/* =====================================
   RESET CORN SOUP QUEST ON SERVER
===================================== */
...
if (telegramInitData) {
    try {
        ...
        const response =
            await fetch(
                "https://server-72ja.onrender.com/api/reset-corn-soup-quest",
                {
                    method: "POST",
                    headers: {
                        "Content-Type":
        ...
        console.log(
            "🌽 CORN SOUP QUEST RESET RESPONSE:",
            data
        );
        ...
        if (
            ...
            console.error(
                "Corn Soup quest server reset failed:",
                data.error
            );
        }
        ...
        console.error(
            "Corn Soup quest server reset error:",
            error
        );
    }
}
